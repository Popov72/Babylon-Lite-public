/**
 * Torus States — a reproduction of Robert Penner's "Torus States"
 * (https://robertpenner.com/demos/#/torus-states), rendered with Babylon Lite's
 * scene-less frame-graph path — no scene, camera, or mesh. The whole image is a
 * single raymarched WGSL fragment shader (twisted-torus SDF with volumetric glow,
 * sine-palette colour, Blinn-Phong specular + Fresnel) that auto-cycles through
 * 7 morph states, with a bloom post-process pass.
 */
import {
    addTask,
