...
if (!existsSync(generatedDts) || statSync(generatedDts).mtimeMs < newestMtime(engineSrcDir)) {
    ...
    execFileSync("pnpm", ["--filter", "babylon-lite", "build:dist"], {
        cwd: repoRoot,
        stdio: "inherit",
...
function normalizeForMonaco(dts: string): string {
    const typedArrays = "Float32Array|Float64Array|Int8Array|Int16Array|Int32Array|Uint8Array|Uint8ClampedArray|Uint16Array|Uint32Array|BigInt64Array|BigUint64Array";
