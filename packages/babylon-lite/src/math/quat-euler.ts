...
export function eulerXYZToQuatTuple(rx: number, ry: number, rz: number): [number, number, number, number] {
...
/** Quaternion → Euler XYZ (inverse of eulerXYZToQuatTuple). */
export function quatToEulerXYZTuple(qx: number, qy: number, qz: number, qw: number): [number, number, number] {
