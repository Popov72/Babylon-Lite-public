...
/**
 * Resolve the settings for this session: defaults, overlaid with anything previously saved, overlaid
 * with query-string overrides. The query string wins so a device-specific link (or a QA run) can pin
 * a setting without disturbing what the player saved.
 *
