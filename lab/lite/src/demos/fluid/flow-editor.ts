...
import { MAX_FLUID_EMITTERS, MAX_FLUID_SINKS } from "babylon-lite/fluid/sim-common.js";
...
export interface FluidFlowEditorVisuals {
    getWireframeVisible(kind: FluidFlowObjectKind): boolean;
    setWireframeVisible(kind: FluidFlowObjectKind, visible: boolean): void;
    getGizmoVisible(kind: FluidFlowObjectKind): boolean;
    setGizmoVisible(kind: FluidFlowObjectKind, visible: boolean): void;
}
...
export interface FluidFlowEditor {
    setFlow(flow: FluidFlowConfig): void;
    clearSelection(refreshEditor?: boolean): void;
    refresh(): void;
    refreshComputedValues(): void;
    getSelected(kind: FluidFlowObjectKind): FluidEmitter | FluidSink | undefined;
}
