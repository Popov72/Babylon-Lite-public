...
(async function () {
    ...
    await SceneLoader.AppendAsync("", "https://cx20.github.io/gltf-test/sampleModels/Duck/glTF-Quantized/Duck.gltf", scene);
    ...
    const camera = new ArcRotateCamera("camera", 1.5707963, 1.5707963, 2.2, new Vector3(0.135, 0.87, -0.04), scene);
    camera.fov = 0.8;
    camera.minZ = 2.2 * 0.01;
    camera.maxZ = 2.2 * 1000;
