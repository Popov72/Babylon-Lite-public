...
(async function () {
    ...
    await SceneLoader.AppendAsync("", "https://cx20.github.io/gltf-test/tutorialModels/NormalTangentTest/glTF/NormalTangentTest.gltf", scene);
    ...
    const camera = new ArcRotateCamera("camera", 1.5707963, 1.5707963, 4.6377, new Vector3(0, -0.125, 0.03525), scene);
    camera.fov = 0.8;
    camera.minZ = 4.6377 * 0.01;
    camera.maxZ = 4.6377 * 1000;
