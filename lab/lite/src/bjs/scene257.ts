// BJS reference for scene 257 — glTF Node_NegativeScale_01.
// Two textured shapes, one mirrored via a negative-determinant matrix. Static.
...
void (async function () {
    ...
    await SceneLoader.ImportMeshAsync("", "/gltf-assets/Node_NegativeScale/", "Node_NegativeScale_01.gltf", scene);
