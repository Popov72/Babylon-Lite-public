// BJS reference for scene 259 — glTF Material_03.
// Flat plane with a dark base and full-white emissiveFactor (no texture). Static.
...
void (async function () {
    ...
    await SceneLoader.ImportMeshAsync("", "/gltf-assets/Material/", "Material_03.gltf", scene);
