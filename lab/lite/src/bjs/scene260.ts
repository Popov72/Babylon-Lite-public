// BJS reference for scene 260 — glTF Mesh_PrimitiveMode_11.
// A quad drawn as a TRIANGLE_STRIP (mode 5) with uint32 indices. Static.
...
void (async function () {
    ...
    await SceneLoader.ImportMeshAsync("", "/gltf-assets/Mesh_PrimitiveMode/", "Mesh_PrimitiveMode_11.gltf", scene);
