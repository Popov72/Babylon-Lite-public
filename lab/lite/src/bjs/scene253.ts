...
(async function () {
    ...
    await SceneLoader.AppendAsync("", "https://cx20.github.io/gltf-test/tutorialModels/AnimateAllTheThings/glTF/AnimateAllTheThings.gltf", scene);
    ...
    const camera = new ArcRotateCamera("camera", Math.PI / 2, 0.02, 16, new Vector3(0.38, 0.4, -2.53), scene);
    camera.fov = 0.8;
    camera.minZ = 0.1;
    camera.maxZ = 100;
