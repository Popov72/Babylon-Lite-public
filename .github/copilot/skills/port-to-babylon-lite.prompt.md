...
| `scene.fogDensity = 0.02`                                      | _(set in fog object above)_                                                   |
| `scene.fogColor = new BABYLON.Color3(r,g,b)`                   | _(set in fog object above)_                                                   |
| `scene.fogStart`, `scene.fogEnd`                               | _(set in fog object above)_                                                   |
...
| `camera.attachControl(canvas, true)`                                     | `attachControl(camera, canvas, scene)` _(arc-rotate)_ or `attachFreeControl(camera, canvas, scene)` _(free)_ |
...
| `camera.minZ = 0.1`                                                      | `camera.minZ = 0.1` _(same)_                                                                                 |
| `camera.maxZ = 1000`                                                     | `camera.maxZ = 1000` _(same)_                                                                                |
| `camera.fov`                                                             | `camera.fov` _(same, default 0.8)_                                                                           |
| `camera.alpha`, `camera.beta`, `camera.radius`                           | _(same property names)_                                                                                      |
...
```typescript
// Babylon.js
const camera = new BABYLON.ArcRotateCamera("cam", -Math.PI / 2, Math.PI / 2, 5, new BABYLON.Vector3(0, 0, 0), scene);
...
| `mesh.receiveShadows = true`                                                                                            | `mesh.receiveShadows = true` _(same)_                                                                 |
...
| KTX2 compressed texture loader                        | `await loadKtxTexture2D(engine, baseUrl, suffixes)` _(auto-selects ASTC/BC/ETC2)_ |
...
| `shadowGen.useBlurExponentialShadowMap = true`                  | _(always ESM blur — it's the only mode)_                     |
...
| Babylon.js                         | Babylon Lite                                                 |
| ---------------------------------- | ------------------------------------------------------------ |
| glTF animations auto-play          | glTF animations auto-play via `loadGltf()` _(same behavior)_ |
...
```typescript
import {} from /* only what you need */ "@babylonjs/lite";
